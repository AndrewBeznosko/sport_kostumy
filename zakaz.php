...
$subject = 'Заказ товара - kara'; // заголовок письмя
$addressat = "yuliagrigorenko99@yandex.ru"; // Ваш Электронный адрес
$success_url = './form-ok.php?name='.$_POST['name'].'&phone='.$_POST['phone'].'&time='.$_POST['Время_звонка'].'&product_id='.$_POST['product_id'].'';
